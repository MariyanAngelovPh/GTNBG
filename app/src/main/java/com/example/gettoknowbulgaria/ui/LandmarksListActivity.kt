...
//        localRecyclerView = findViewById(R.id.recyclerViewLocal)
        ...
        val cities = listOf("Град:", "Пловдив", "Видин", "Враца", "Велико Търново", "Бургас", "Петрич", "Варна", "Елена", "Козлодуй", "Габрово", "с. Боженците", "Трявна", "Дряново", "Добрич",
            "Балчик", "Каварна", "Кърджали", "Кюстендил", "Ловеч", "с. Деветаки", "с. Крушуна", "с. Карлуково", "с. Орешак", "Троян", "Берковица", "Монтана", "Пазарджик", "Пещера", "Асеновград", "Русе", "Сливен", "София")
